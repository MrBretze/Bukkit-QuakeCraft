...
public class ColorScroller
{
    ...
    public String next()
    {
        ...
        if (position >= str.length())
        {
            ...
            } else
            {
                ...
                String fin = textColor + str.substring(0, str.length() - 1) +
                        colorBefore + str.substring(str.length() - 1) + two;
        ...
        if (position <= -1)
        {
            ...
            if (bold)
            {
                return colorBefore + ChatColor.BOLD + str.substring(0, 1) + textColor + ChatColor.BOLD + str.substring(1);
            } else
            {
                return colorBefore + str.substring(0, 1) + textColor + str.substring(1);
            }
        }

...
public class RayGun extends Gun
{
    public RayGun(PlayerInfo info)
    {
        ...
        if (meta != null)
        {
            setName(ChatColor.GREEN + "Ray Gun");
    ...
    public void applyEffect(Location location)
    {
        ...
        if (world != null)
        {
            world.spawnParticle(Particle.REDSTONE, location, 2, 0.05, 0.05, 0.05, 0.05,
                    new Particle.DustOptions(Color.fromBGR(255, 255, 0), 1), true);
        }
    }
}

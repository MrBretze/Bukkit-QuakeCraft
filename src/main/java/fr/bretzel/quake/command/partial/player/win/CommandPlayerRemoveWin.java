...
public class CommandPlayerRemoveWin extends ICommandPlayer {

    private int i;

    public CommandPlayerRemoveWin(CommandSender sender, Command command, Permission permission, String[] args, Player player, int i) {
    ...
    public PartialCommand execute() {
        ...
        info.removeWin(i);
        getPlayer().sendMessage(getI18n("command.players.removewon.valid").replace("%win%", "" + i));

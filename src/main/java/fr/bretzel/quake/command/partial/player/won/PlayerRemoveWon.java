 ...
 */
public class PlayerRemoveWon extends IPlayer
{

    private final int i;

    public PlayerRemoveWon(CommandSender sender, Command command, Permission permission, String[] args, Player player, int i)
    {

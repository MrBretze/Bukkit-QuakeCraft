 ...
 */
public class CommandPlayerAddKillStreak extends ICommandPlayer {

    private int i;

    public CommandPlayerAddKillStreak(CommandSender sender, Command command, Permission permission, String[] args, Player player, int i) {
    ...
    public PartialCommand execute() {
        ...
        info.addKillStreak(i);
        getPlayer().sendMessage(getI18n("command.players.addkillsteak.valid").replace("%killstreak%", "" + i));

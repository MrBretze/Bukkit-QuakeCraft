...
public class ScoreboardTask extends GameTask
{
    ...
    private final ColorScroller scroller = new ColorScroller(ChatColor.RED, "QuakeCraft", ChatColor.RED.toString(), ChatColor.DARK_RED.toString(), ChatColor.RED.toString(), true, false, ColorScroller.ScrollType.FORWARD);

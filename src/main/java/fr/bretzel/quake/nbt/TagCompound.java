...
/**
 * @auhtor Johannes Donath <johannesd@evil-co.com> and modified by MrBretzel
...
public class TagCompound extends AbstractTag implements INamedTagContainer {
    ...
    public void setList(String name, List<ITag> value) {
        this.setTag(new TagList(name, value));
    }

    public void setStringList(String name, Collection<String> value) {

        TagList list = new TagList(name);
        for(String s : value) {
            list.addTag(new TagString("", s));
        }
        this.setTag(list);
    }
    ...
    public void setFloat(String name, short value) {
